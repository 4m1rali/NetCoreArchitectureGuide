# Chapter 15 — WAN Types (PPPoE, LTE, DHCP)

> Configuration templates for different ISP handoff types.
...
**Critical:** `add-default-route=no` — you manage routes manually for Multi-WAN.
...
Do not include LTE in PCC classifier — use as failover-only to avoid costly data usage.
...
**Next Chapter →** [Chapter 16: Security Hardening](../16-security-hardening/README.md)

# Chapter 23 — Automation & Scripting

> Automated Multi-WAN management with RouterOS scripts and schedulers.

---

## 23.1 Dynamic Route Update on DHCP WAN
...
## 23.2 Automatic PCC Rebalance Check
...
## 23.3 WAN Failover Telegram/Email Alert
...
## 23.4 Scheduled Config Backup to FTP
...
## 23.5 Disable Dead WAN from PCC Classifier
...
## 23.6 REST API Monitoring (RouterOS 7)
...
Use REST API for integration with Grafana, Prometheus, or custom NOC dashboards.

---

**Next Chapter →** [Chapter 24: Disaster Recovery](../24-disaster-recovery/README.md)

# Chapter 5 — MikroTik Full Configuration

> Production-ready RouterOS configuration. Copy-paste ready. No inline comments.

---

## 5.1 Interface and IP Setup
...
## 5.2 WAN Gateway and Recursive Routes
...
Place these rules **before** PCC classifier rules in mangle chain.
...
## 5.20 Configuration Order (Deployment Sequence)

| Step | Section | Action |
|------|---------|--------|
| 1 | 5.1 | Interface lists and IP addresses |
| 2 | 5.2 | Recursive gateway routes |
| 3 | 5.3 | Create routing tables |
...
**Next Chapter →** [Chapter 6: Debugging & Troubleshooting](../06-debugging-troubleshooting/README.md)

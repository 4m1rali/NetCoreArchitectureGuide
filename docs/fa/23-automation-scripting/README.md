# فصل ۲۳ — Automation و Scripting

> مدیریت خودکار Multi-WAN با Script و Schedulerهای RouterOS.

---

## ۲۳.۱ به‌روزرسانی Dynamic Route روی WAN DHCP
...
## ۲۳.۲ بررسی خودکار Rebalance PCC
...
## ۲۳.۳ هشدار Failover WAN با Telegram/Email
...
## ۲۳.۴ پشتیبان Config زمان‌بندی‌شده به FTP
...
## ۲۳.۵ غیرفعال‌سازی WAN مرده از Classifier PCC
...
## ۲۳.۶ مانیتورینگ REST API (RouterOS 7)
...
از REST API برای یکپارچه‌سازی با Grafana، Prometheus یا داشبوردهای NOC سفارشی استفاده کنید.

---

**فصل بعد →** [فصل ۲۴: Disaster Recovery](../24-disaster-recovery/README.md)

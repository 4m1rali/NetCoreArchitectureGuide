# Глава 4 — Production Design

> Реальная 3-ISP Multi-WAN архитектура с полным анализом потока трафика.
...
| Компонент | Детали |
|-----------|--------|
| Router | MikroTik CCR2004-16G-2S+ (или RB4011) |
| RouterOS | 7.x |
...
## 4.3 Диаграмма потока трафика

### Исходящий поток трафика (PCC)
...
## 4.4 Поток принятия маршрутного решения
...
## 4.6 Путь пакета — полный пример

**Запрос:** пользователь `192.168.1.50` открывает `https://google.com`

| Шаг | Место | Действие | Детали |
|-----|-------|----------|--------|
...
## 4.7 Failover Scenario в этом дизайне
...
**Следующая глава →** [Глава 5: MikroTik Configuration](../05-mikrotik-configuration/README.md)

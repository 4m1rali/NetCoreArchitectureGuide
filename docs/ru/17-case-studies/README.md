# Глава 17 — Real-World Case Studies

> Production deployment scenarios с архитектурными решениями и lessons learned.
...
**Далее →** [Приложение A: Glossary](../appendix/glossary.md)

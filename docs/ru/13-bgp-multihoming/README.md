# Глава 13 — BGP Multi-Homing

> ISP-grade multi-homed internet connectivity с BGP на MikroTik.

---

## 13.1 Когда BGP заменяет PCC

| Сценарий | Метод |
|----------|-------|
| SOHO / Branch (2–3 ISP) | PCC + Failover |
| Enterprise с public /24+ | BGP multi-homing |
| ISP с own ASN | BGP to multiple upstreams |
| Datacenter | BGP + ECMP |

BGP уместен, когда у вас есть **provider-independent IP space** и **ASN**, и ISP согласны на BGP peering.
...
**Следующая глава →** [Глава 14: Monitoring & Operations](../14-monitoring-operations/README.md)

# Глава 12 — IPv6 Multi-WAN

> Dual-stack и IPv6-only Multi-WAN на MikroTik RouterOS 7.

---

## 12.1 Отличия IPv6 Multi-WAN от IPv4
...
Когда LAN использует ULA (fd00::/48) и должен представлять разные ISP prefixes:
...
**Следующая глава →** [Глава 13: BGP Multi-Homing](../13-bgp-multihoming/README.md)
